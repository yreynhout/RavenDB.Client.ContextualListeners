...
namespace Tests.Raven.Client.ContextualListeners.HaackHttpSimulator
{
    ...
    /// <summary>
    ///     Useful class for simulating the HttpContext. This does not actually make an HttpRequest, it merely simulates the
    ///     state that your code would be in "as if" handling a request. Thus the HttpContext.Current property is populated.
    /// </summary>
    public class HttpSimulator : IDisposable
    {
        ...
        /// <summary>
        ///     The same thing as the IIS Virtual directory. It's what gets returned by Request.ApplicationPath.
        /// </summary>
            ...
            NameValueCollection headers)
        {
            ...
            workerRequest = new SimulatedHttpRequest(ApplicationPath, PhysicalApplicationPath, PhysicalPath, Page, query,
                responseWriter, host, port, httpVerb.ToString());
        ...
        public class FakeHttpSessionState : NameObjectCollectionBase, IHttpSessionState
        {
            ...
            /// <summary>
            ///     Copies the collection of session-state item values to a one-dimensional array, starting at the specified index in
            ///     the array.
            /// </summary>
            ...
            /// <summary>
            ///     Gets and sets the time-out period (in minutes) allowed between requests before the session-state provider
            ...
            /// </summary>
            /// <returns>
            ///     One of the <see cref="T:System.Web.HttpCookieMode"></see> values that indicate whether the application is
            ///     configured for cookieless sessions. The default is
            ///     <see
            ///         cref="F:System.Web.HttpCookieMode.UseCookies">
            ///     </see>
            ///     .
            /// </returns>
            ...
            /// </summary>
            /// <returns>
            ///     A <see cref="T:System.Globalization.CultureInfo"></see> instance that specifies the culture of the current
            ///     session.
            /// </returns>
            ...
            /// <summary>
            ///     Gets a collection of objects declared by &lt;object Runat="Server" Scope="Session"/&gt; tags within the ASP.NET
            ///     application file Global.asax.
            /// </summary>
            /// <returns>
            ///     An <see cref="T:System.Web.HttpStaticObjectsCollection"></see> containing objects declared in the Global.asax
            ///     file.
            /// </returns>
